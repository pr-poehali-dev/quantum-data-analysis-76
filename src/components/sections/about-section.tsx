      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid gap-8 md:grid-cols-2 md:gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              <h2 className="mb-3 font-sans text-3xl font-light leading-[1.1] tracking-tight text-foreground md:mb-4 md:text-6xl lg:text-7xl">
                ...
                в самый
                <br />
                <span className="text-foreground/40">трудный день</span>
              </h2>
            </div>
          ...
          <div className="flex flex-col justify-center space-y-6 md:space-y-12">
            {[
              { value: "15+", label: "Лет", sublabel: "Работаем в Самаре и области", direction: "right" },
              { value: "5000+", label: "Семей", sublabel: "Доверились нам в трудный час", direction: "left" },
              { value: "24/7", label: "Поддержка", sublabel: "Звонок принимаем в любое время", direction: "right" },
            ].map((stat, i) => {
